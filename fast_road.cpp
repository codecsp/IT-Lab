...
public: 
	...
	void shortestPath(double s, double d); 
}; 
...
{ 
	this->V = V; 
	adj = new list< pair<double, double> >[V]; 
} 
...
void Graph::shortestPath(double src,double dest) 
{ 
	...
	//for (int i = 0; i < V; ++i) 
	//	printf("%d \t\t %d\n", i, dist[i]); 
	//cout<<fixed<<setprecision(8)<<dist[dest]<<endl;
